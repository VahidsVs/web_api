...
--
-- Host: localhost
-- Generation Time: Aug 06, 2023 at 08:15 PM
...
(3, 'Contact Us', 'contact_us', '<p>MegaTech is an IT company which works in the field of applications, newtork, web design, blockchain and AI. MegaTech is an innovative start-up company.</p><p><strong>For any inquiry such as (Projects, Supports, Services, ...) please contact us using contact information or fill-in the form below and Submit</strong><br /></p>', '783e43d5-f6e1-11ed-abf9-005056c00001', '', '', '2023-07-22 20:04:09', '2023-07-29 10:58:47'),
...
CREATE TABLE `pages_permission` (
  ...
  `fk_role_title` varchar(64) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `pages_permission` (`page_url`, `fk_role_title`) VALUES
('/admin/contact_us.html', 'ContactUs'),
('/admin/media_management.html', 'MediaManagement'),
('/admin/page_management.html', 'PageManagement'),
('/admin/permission_level_management.html', 'PermissionLevelManagement'),
('/admin/post_management.html', 'PostManagement');
...
ALTER TABLE `pages_permission`
  ADD PRIMARY KEY (`page_url`,`fk_role_title`),
  ADD KEY `page_permission-roles` (`fk_role_title`);
...
--
-- Constraints for table `pages_permission`
--
ALTER TABLE `pages_permission`
  ADD CONSTRAINT `page_permission-roles` FOREIGN KEY (`fk_role_title`) REFERENCES `roles` (`title`);
