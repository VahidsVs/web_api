...
/* harmony import */ var _admin_localization__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../admin_localization */ "./admin_localization.ts");
...
let CmsNotification = class CmsNotification extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    ...
    constructor() {
        ...
        this.lcid = 'fa';
        this.resources = [];
        this.lcid = (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getCookie)("lcid");
        this.resources = (0,_admin_localization__WEBPACK_IMPORTED_MODULE_3__.getLangResources)()[this.lcid];
    }
    ...
    async performUpdate() {
        switch (this.ComponentName) {
            ...
            case "cms-permissionlevelmanagement":
                this.ModuleRender = lit__WEBPACK_IMPORTED_MODULE_0__.html `<cms-permissionlevelmanagement></cms-permissionlevelmanagement>`;
                break;
        }
        super.performUpdate();
    }
...
let CmsHeader = class CmsHeader extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    createRenderRoot() {
        return this;
    }
    constructor() {
...
<li class="nav-item dropdown">
    ...
    <li class="nav-item">
        ...
        this.PnlLogin = lit__WEBPACK_IMPORTED_MODULE_0__.html `${this.PnlLoginItems}`;
    }
    async performUpdate() {
        super.performUpdate();
    }
    ...
    ChangeLanguage(lcid) {
        ...
        var resources = (0,_admin_localization__WEBPACK_IMPORTED_MODULE_3__.getLangResources)()[lcid];
    ...
    logout(e) {
        e.preventDefault();
        (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.PostDataForm)("user_account/logout.php", null)
            .then(data => {
...
__decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.state)()
], CmsHeader.prototype, "PnlLoginItems", void 0);
__decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.state)()
], CmsHeader.prototype, "PnlLogin", void 0);
CmsHeader = __decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.customElement)('cms-header')
], CmsHeader);
...
let CmsFooter = class CmsFooter extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    createRenderRoot() {
        return this;
    }
    constructor() {
...
CmsFooter = __decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.customElement)('cms-footer')
], CmsFooter);
...
/******/ })()
;
//# sourceMappingURL=admin_template.bundle.js.map