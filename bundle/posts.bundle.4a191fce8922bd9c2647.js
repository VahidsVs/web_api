...
let CmsPosts = class CmsPosts extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    createRenderRoot() {
        return this;
    }
    constructor() {
        ...
        let page = (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getParameterByName)("page");
        if (page) {
            try {
    ...
    ShowPosts() {
        let pageSize = 2;
        (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.GetData)("post/select_post_pagination.php", { pac: '18PrB1fS1RtyZ550c5QR5Q', pageSize: pageSize, page: this.currentPage })
            .then(item => {
...
`);
            ...
            this.Pagination.push(lit__WEBPACK_IMPORTED_MODULE_0__.html `
...
CmsPosts = __decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.customElement)('cms-posts')
], CmsPosts);
...
/******/ var __webpack_exports__ = (__webpack_exec__("./site/page/posts.ts"));
/******/ }
]);
//# sourceMappingURL=posts.bundle.4a191fce8922bd9c2647.js.map