...
let CmsIndex = class CmsIndex extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    ...
    ShowPosts() {
        (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.GetData)("post/select_post.php", { pac: encodeURIComponent('18PrB1fS1RtyZ550c5QR5Q'), pageSize: 3 }, "#pnlNews")
            .then(data => {
            for (let i = 0; i < data.length; i++) {
                const element = data[i];
                this.NewsPosts.push(lit__WEBPACK_IMPORTED_MODULE_0__.html `
...
`);
    ...
    ShowProjects() {
        (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.GetData)("post/select_post.php", { pac: encodeURIComponent('Xe9dNreyFQIVzZbEfp9+xg=='), pageSize: 2 }, "#pnlProjects")
            .then(data => {
            for (let i = 0; i < data.length; i++) {
                const element = data[i];
                this.Projects.push(lit__WEBPACK_IMPORTED_MODULE_0__.html `
...
`);
    ...
    ShowTestimonials() {
        (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.GetData)("post/select_post.php", { pac: encodeURIComponent('mQrpkmSlCzCsPPZpiGXSmw=='), pageSize: 3 }, "#pnlTestimonials")
            .then(data => {
            for (let i = 0; i < data.length; i++) {
                const element = data[i];
                this.Testimonials.push(lit__WEBPACK_IMPORTED_MODULE_0__.html `
...
`);
            ...
            this.Testimonials = lit__WEBPACK_IMPORTED_MODULE_0__.html `${this.Testimonials}`;
            this.requestUpdate();
        });
    }
            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    <div class="container carousel-content">
                        ...
                        <a href="/about_us.html" class="me-2"><button type="button" class="px-4 py-sm-3 px-sm-5 btn btn-primary rounded-pill carousel-content-btn1 animated fadeInLeft">About Us</button></a>
                        <a href="/contact_us.html" class="ms-2"><button type="button" class="px-4 py-sm-3 px-sm-5 btn btn-primary rounded-pill carousel-content-btn2 animated fadeInRight">Contact Us</button></a>
                    </div>
                </div>
            </div>
...
<div class="container-fluid project py-5 mb-5" id="pnlProjects">
    <div class="container">
        ...
        <div class="row g-5">
            ${lit__WEBPACK_IMPORTED_MODULE_0__.html `${this.Projects}`}
        </div>
    </div>
</div>
<!-- Project End -->
...
<div class="container-fluid blog py-5 mb-5" id="pnlNews">
    <div class="container">
        ...
        <div class="row g-5 justify-content-center p-2">
            ${lit__WEBPACK_IMPORTED_MODULE_0__.html `${this.NewsPosts}`}
        </div>
...
<div class="container-fluid testimonial py-5 mb-5" id="pnlTestimonials">
    <div class="container">
        ...
        <div class="row g-5 justify-content-center">
            ${lit__WEBPACK_IMPORTED_MODULE_0__.html `${this.Testimonials}`}
        </div>
    </div>
</div>
<!-- Testimonial End -->
...
//# sourceMappingURL=index.bundle.39331473cb11c07cf21d.js.map