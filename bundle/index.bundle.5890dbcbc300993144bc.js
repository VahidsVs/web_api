...
let CmsIndex = class CmsIndex extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    ...
    ShowPosts() {
        (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.GetData)("post/select_post.php", { pac: '18PrB1fS1RtyZ550c5QR5Q', limit: 3 }, "#pnlNews")
            .then(data => {
...
`);
    ...
    ShowTestimonials() {
        (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.GetData)("post/select_post.php", { pac: 'mQrpkmSlCzCsPPZpiGXSmw==' }, "#pnlTestimonials")
            .then(data => {
            for (let i = 0; i < data.length; i++) {
                const element = data[i];
...
//# sourceMappingURL=index.bundle.5890dbcbc300993144bc.js.map