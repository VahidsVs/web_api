...
/* harmony import */ var _site_localization__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../site_localization */ "./site_localization.ts");
...
let CmsRegister = class CmsRegister extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    createRenderRoot() {
        return this;
    }
    ClearScr() {
    ...
    constructor() {
        ...
        this.resources = (0,_site_localization__WEBPACK_IMPORTED_MODULE_4__.getLangResources)()[this.lcid];
    }
    firstUpdated(changedProperties) {
        knockout__WEBPACK_IMPORTED_MODULE_3__.applyBindings(this.Model, document.getElementById("pnlRegister"));
    }
    btnRegister_Click() {
        (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.PostDataForm)("user_account/register.php", knockout__WEBPACK_IMPORTED_MODULE_3__.toJS(this.Model.data), "#pnlLoading")
            .then(data => {
...
CmsRegister = __decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.customElement)('cms-register')
], CmsRegister);
