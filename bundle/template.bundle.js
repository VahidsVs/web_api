...
/* harmony import */ var lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lit/decorators.js */ "../node_modules/lit/decorators.js");
/* harmony import */ var _cms_general__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../cms_general */ "./cms_general.ts");
/* harmony import */ var _site_localization__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../site_localization */ "./site_localization.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
<li class="nav-item dropdown">
    ...
    ChangeLanguage(lcid) {
        ...
        var resources = (0,_site_localization__WEBPACK_IMPORTED_MODULE_3__.getLangResources)()[lcid];
    ...
    logout(e) {
        e.preventDefault();
        (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.PostData)("user_account/logout.php", null)
            .then(data => {
