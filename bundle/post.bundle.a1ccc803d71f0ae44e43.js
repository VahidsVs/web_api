...
/* harmony import */ var lit_html_directives_unsafe_html_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lit-html/directives/unsafe-html.js */ "../node_modules/lit-html/development/directives/unsafe-html.js");
...
let CmsPost = class CmsPost extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    createRenderRoot() {
        return this;
    }
    constructor() {
    ...
    ShowPosts() {
        let slug = (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.getParameterByName)('slug');
        (0,_cms_general__WEBPACK_IMPORTED_MODULE_2__.GetData)("post/select_post.php", { pac: '18PrB1fS1RtyZ550c5QR5Q', slug: slug })
            .then(data => {
            if (data.length == 1) {
                document.title = data[0].title;
                this.Title = data[0].title;
                this.Summary = data[0].summary;
                this.Content = lit__WEBPACK_IMPORTED_MODULE_0__.html `${(0,lit_html_directives_unsafe_html_js__WEBPACK_IMPORTED_MODULE_3__.unsafeHTML)(data[0].content)}`;
...
], CmsPost.prototype, "Title", void 0);
__decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.state)()
], CmsPost.prototype, "Summary", void 0);
__decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.state)()
], CmsPost.prototype, "Content", void 0);
CmsPost = __decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.customElement)('cms-post')
], CmsPost);
...
/******/ var __webpack_exports__ = (__webpack_exec__("./site/page/post.ts"));
/******/ }
]);
//# sourceMappingURL=post.bundle.a1ccc803d71f0ae44e43.js.map